...
import helloScene from "../assets/3d/goodHello.glb";
import helloVoice from "../assets/voice/hello.mp3";
import * as THREE from "three";
import { useFrame, useThree } from "@react-three/fiber";
import useDeviceType from "../hooks/useDeviceType";

function Hello({ isPlayingMusic, ...props }) {
  // refs
  ...
  const { nodes, materials, animations } = useGLTF(helloScene);
  ...
  useEffect(() => {
    ...
    if (actions["tmp95h7wx6v.plyAction.014"]) {
      ...
      actions["tmp95h7wx6v.plyAction.014"].timeScale = 1.25; // Speeds up to 1.25% speed
